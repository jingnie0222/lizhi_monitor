...
scene_dir = ['bd_lizhi_sg_other', 'sg_lizhi_bd_baike', 'sg_lizhi_bd_official', 'sg_lizhi_bd_other', 'sg_lizhi_bd_lizhi']
...
def fetch_and_analysis(word_list, query_from, queue):
    ...
    queue.put(("quit", None, None, None, None))
...
def parallel_process(wordlist, query_from):
    ...
    try:
        ...
        while True:
            ...
            #insert_sql = '''insert into diff_result\
                          #(word, queryfrom, fetchfrom, lizhi, vr, baike, official, other, error, resolve) values \
                          #(word, query_from, engine, );'''
